            ...
            <div class="container">
                ...
                <p style="margin-top:18px;">
                    <a class="btn btn--primary" target="_blank" rel="noopener"
                        href="https://docs.google.com/forms/d/REPLACE_WITH_YOUR_FORM_ID/viewform?usp=pp_url&utm_source=lp&utm_medium=cta&utm_campaign=kanazawa">
                        お問い合わせ（Googleフォーム）
                    </a>
                </p>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="footer-links">
                <a href="https://chiiki-junkanyu.jp/">公式ホームページへ</a>
            </div>
